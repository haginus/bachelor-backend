...
export function StatutoryDeclaration({ student, paper, sessionSettings, signatureSample }: StudentDocumentGenerationProps) {
  return (
    <Document title={`Declarație pe proprie răspundere - ${student.lastName} ${student.firstName}`}>
      <Page size="A4" style={[styles.page]}>
        ...
        <Text style={{ fontSize: 14, textAlign: 'justify' }}>
          Subsemnatul/Subsemnata {student.lastName} {student.firstName}, candidat la examenul de{' '}
