...
export default function SignUpRequestNotice({ signUpRequest, url }: EmailProps) {
  return (
    <MailScreen heading={`Cerere nouă de înregistrare de la ${signUpRequest.firstName} ${signUpRequest.lastName}`}>
      ...
      <Text style={styles.quoteParagraph}>
        ...
        <span>Specializare: {signUpRequest.specialization?.name} - {signUpRequest.specialization?.studyForm.toLocaleUpperCase()}</span> <br/>
